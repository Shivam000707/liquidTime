  ...
  return (
    <motion.div
      style={{
        ...
        transformOrigin: "0%",
        background:
          "linear-gradient(90deg, rgba(16,185,129,0.9) 0%, rgba(52,211,153,0.85) 50%, rgba(163,230,53,0.9) 100%)",
      }}
    />
  );
}
...
const MARQUEE_SEGMENT =
  "Your Day · Flows Like Liquid · AI Scheduling · Voice First · On Device · ";
...
function Navbar({ onEnter }) {
  ...
  return (
    ...
    >
      ...
      {/* Center pill — always mathematically centered */}
      <div style={{ justifySelf: "center" }}>
        <div
          className="liquid-glass-mint hidden md:flex"
          style={{
            alignItems: "center",
            padding: "6px",
            borderRadius: 9999,
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Describe the life you want. AI generates your perfect schedule.
            Adjust with your voice in seconds.
          </motion.p>
          ...
          >
            <button
              ...
              style={{
                ...
                boxShadow:
                  "0 0 28px rgba(16,185,129,0.50), 0 0 56px rgba(16,185,129,0.18), inset 0 1px 0 rgba(255,255,255,0.18)",
              }}
            >
      ...
      <section
        ...
        style={{
          ...
          flexDirection: "column",
          padding:
            "clamp(64px,10vh,96px) clamp(20px,5vw,80px) clamp(40px,6vh,60px)",
        }}
      >
        <AmbientBg />
          ...
          >
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                boxShadow:
                  "0 0 20px rgba(16,185,129,0.45), 0 0 40px rgba(16,185,129,0.15)",
              }}
            >
